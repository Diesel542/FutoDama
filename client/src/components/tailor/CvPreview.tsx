...
export function CvPreview({ bundle, template, candidateName, fullWidth = false }: CvPreviewProps) {
  ...
  if (fullWidth) {
    return (
      <div 
        className={`bg-white w-full p-10 ${fontFamilyClass}`}
        data-testid="cv-preview-fullwidth"
      >
